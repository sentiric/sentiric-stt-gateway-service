    ...
    N: for<'a> FormatFields<'a> + 'static,
{
    fn format_event(
        ...
        // SUTS v4.0: Level yerine 'severity'
        ...
        // [ARCH-COMPLIANCE] Strict SUTS v4.0 JSON Şeması
        let log_obj = json!({
            "schema_v": "1.0.0",
...
// Tracing Event verilerini güvenli bir şekilde çekip BTreeMap'e aktaran Ziyaretçi (Visitor)
#[derive(Default)]
struct SutsVisitor {
